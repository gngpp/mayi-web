...
<!--        </div>-->
      ...
      >
        ...
        <el-table-column v-permission="['ROLE_root','dict:edit','dict:del']" label="操作" width="130px" align="center" fixed="right">
...
export default {
  ...
  data() {
    return {
      ...
      permission: {
        add: ['ROLE_root', 'dict:add'],
        edit: ['ROLE_root', 'dict:edit'],
        del: ['ROLE_root', 'dict:del']
      },
